...
const user = { email: 'janesroberta@gmail.com', password: 'teste123' }
...
// métodos de string
const fullName = 'Roberta'

console.log(fullName.length) // 16

const stringToArray = fullName.split(' ')

console.log(stringToArray) // ["Roberta", ]

console.log(fullName.toLowerCase()) // Roberta

console.log(fullName.toUpperCase()) // Roberta

console.log(fullName.indexOf('Battisti')) // 8

console.log(fullName.slice(0, 7)) // Roberta
...
// array methods
const names = ['Roberta', 'João', 'Pedro', 'Maria']
...
const saudacao = nomeCompleto('Roberta', )
